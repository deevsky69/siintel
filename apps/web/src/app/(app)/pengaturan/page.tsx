  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <p className="mt-3 text-[10px] leading-relaxed text-ink-faint">{config.config_basis}</p>
      </Panel>
                  ...
                  <tbody>
                    {profile.factors.map((factor) => (
                      <tr key={factor.factor} className="border-t border-base-800 align-top">
                        <td className="py-1.5 pr-3 font-mono text-[11px] text-ink">
                          {factor.factor}
                        </td>
                        <td
                        ...
                        <td className="py-1.5 pr-3 text-right text-[10px] text-ink-faint">
                          {factor.persisted ? "ya" : "tidak"}
                        </td>
                        <td className="py-1.5 text-[10px] leading-relaxed text-ink-faint">
                          {factor.basis ?? "—"}
                        </td>
                      </tr>
                    ))}
      ...
      <Panel title="Cara Mengubah Konfigurasi">
        <p className="text-xs leading-relaxed text-ink-muted">
          ...
          di <span className="font-mono text-[11px]">config/risk/</span>, lalu membangun ulang image
          API — perubahan config <strong>tidak</strong> terbaca dengan sekadar memuat ulang
          container.
        </p>
