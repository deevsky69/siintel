...
/** Keadaan gagal layar operasi (CLAUDE.md §23). */
export default function OperationError({ reset }: { error: Error; reset: () => void }) {
  return (
    <Panel title="Antrean & Tindakan Operasional">
      <ErrorState label="Tindakan operasional gagal dimuat." />
